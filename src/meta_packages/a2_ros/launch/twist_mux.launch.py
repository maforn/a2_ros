...
def generate_launch_description():
    default_config_locks = os.path.join(get_package_share_directory('a2_ros'),
                                        'config', 'twist_mux', 'twist_mux_locks.yaml')
    default_config_topics = os.path.join(get_package_share_directory('a2_ros'),
                                         'config', 'twist_mux', 'twist_mux_topics.yaml')
