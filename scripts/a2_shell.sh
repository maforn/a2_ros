...
_a2_complete() {
    ...
    local commands="source build clean env log sim nuc walk stop unlock stand sit \
keyboard nav explore dlio resple detect topics nodes bag plotjuggler foxglove router verify ps down help"
